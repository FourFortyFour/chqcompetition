...
class ResponseParser:
    ...
    def stage_1(self,):
        ...
        meds = [medium.strip().lower().replace(" ", "-") for medium in splitup_2.pop().split(",")]
        date = "NA"
        ...
        for field in splitup_2:
            ...
            self.fields[broken_field[0].lower().replace(" ", "-")] = broken_field[1].strip()
    ...
    def stage_3(self,):
        ...
        les = ['prepare', 'plan', "investigate",'apply', 'connect', 'evaluate', 'assessment', 'reflect']
